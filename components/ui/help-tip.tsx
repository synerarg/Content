      ...
      <TooltipPrimitive.Root>
        ...
        <TooltipPrimitive.Portal>
          <TooltipPrimitive.Content
            ...
            sideOffset={6}
            collisionPadding={12}
            className="z-50 max-w-xs origin-(--radix-tooltip-content-transform-origin) rounded-lg bg-popover px-3 py-2 text-xs leading-relaxed text-popover-foreground ring-1 ring-foreground/10 duration-150 data-[state=delayed-open]:animate-in data-[state=closed]:animate-out data-[state=delayed-open]:fade-in-0 data-[state=closed]:fade-out-0 data-[state=delayed-open]:zoom-in-95 data-[state=closed]:zoom-out-95"
          >
            {children}
